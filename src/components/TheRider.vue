<template>
    ...
    <div class="row content-medium mb-0 pt-2">
        <h1 class="col mb-3">Francesco Bagnaia</h1>
    </div>
  ...
  <div class="ps-4 pt-5 text-white">
    ...
    <div class="row background-grey mt-4 mb-5">
        ...
        <div class="pt-3">
            ...
            <div class="point">Enea Bastianini</div>
        </div>
    </div>
  </div>
        </div>
...
<br><br>
The Italian's 2022 season got off to a slow start and a crash at the Sachsenring left him 91 points away from the Championship lead, before a stellar run in the second half of the campaign saw Bagnaia do what once seemed impossible and clinch his first premier class crown in Valencia. Sporting the number 1 in 2023, Bagnaia managed to fend off Jorge Martin at the season finale to become the first rider to successfully defend the #1 plate since Mick Doohan, and joined Valentino Rossi and Marc Marquez in becoming the only riders in MotoGP™ to win back-to-back titles.</p>
            </div>
        </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="text-end">14/01/1997</td>
    </tr>
    <tr>
