    ...
    <header class="bg-white shadow-md sticky top-0 z-10">
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <PopoverGroup class="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Thu đông </a>
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900 mr-6"><font-awesome-icon :icon="['fas', 'heart']" /></a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900 mr-6"><font-awesome-icon :icon="['fas', 'cart-shopping']" /></a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900 mr-6"><font-awesome-icon :icon="['fas', 'user']" /></a>
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="space-y-2 py-6">
                ...
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Thu đông</a>
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Kids</a>
